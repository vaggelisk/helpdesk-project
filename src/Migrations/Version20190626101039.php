 ...
 */
final class Version20190626101039 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE uv_saved_filters (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, name VARCHAR(191) NOT NULL, filtering LONGTEXT DEFAULT NULL, route VARCHAR(191) DEFAULT NULL, date_added DATETIME NOT NULL, date_updated DATETIME NOT NULL, INDEX IDX_E1BFBAF7A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE uv_ticket_attachments (id INT AUTO_INCREMENT NOT NULL, thread_id INT DEFAULT NULL, name LONGTEXT DEFAULT NULL, path LONGTEXT DEFAULT NULL, content_type VARCHAR(255) DEFAULT NULL, content_id VARCHAR(255) DEFAULT NULL, size INT DEFAULT NULL, file_system VARCHAR(255) DEFAULT NULL, INDEX IDX_FE918C8EE2904019 (thread_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE uv_saved_replies (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, template_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, subject VARCHAR(255) DEFAULT NULL, is_predefind TINYINT(1) DEFAULT \'1\', template_for VARCHAR(255) DEFAULT NULL, message LONGTEXT NOT NULL, message_inline LONGTEXT DEFAULT NULL, INDEX IDX_39C8BA50A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE uv_support_privilege (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(191) NOT NULL, description LONGTEXT NOT NULL, privileges LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\', created_at DATETIME NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE uv_user (id INT AUTO_INCREMENT NOT NULL, email VARCHAR(191) DEFAULT NULL, proxy_id VARCHAR(191) DEFAULT NULL, password VARCHAR(191) DEFAULT NULL, first_name VARCHAR(191) NOT NULL, last_name VARCHAR(191) DEFAULT NULL, is_enabled TINYINT(1) NOT NULL, verification_code VARCHAR(191) DEFAULT NULL, UNIQUE INDEX UNIQ_E8D39F61E7927C74 (email), UNIQUE INDEX UNIQ_E8D39F61DB26A4E (proxy_id), UNIQUE INDEX UNIQ_E8D39F61E821C39F (verification_code), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE uv_prepared_responses (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, description VARCHAR(2500) DEFAULT NULL, type VARCHAR(255) DEFAULT \'public\', actions LONGTEXT NOT NULL COMMENT \'(DC2Type:array)\', status TINYINT(1) DEFAULT \'1\', date_added DATETIME NOT NULL, date_updated DATETIME NOT NULL, INDEX IDX_8AB5F066A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
